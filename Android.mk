...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -DID='"zenjeqt"' -DVERSION='"0.1.2"' -I'./shared' -I'./extern' -isystem'extern/codegen/include'
ifeq ($(strip $(NDK_DEBUG)),1)
    $(info Building debug)
    LOCAL_SRC_FILES += $(call rwildcard,test/,*.cpp)
    LOCAL_CFLAGS += -DZENJEQT_DEBUG -I'./test'
endif
